...
class Sbi
{
    public:
        ...
        static constexpr unsigned long EXT_CONSOLE      = 0x4442434E;   // "DBCN"
        ...
        static constexpr unsigned long CONSOLE_WRITE      = 0;
        static constexpr unsigned long CONSOLE_READ       = 1;
        static constexpr unsigned long CONSOLE_WRITE_BYTE = 2;
        ...
        static void puts(const char *string, unsigned long size)
        {
            call (EXT_CONSOLE, CONSOLE_WRITE, size, reinterpret_cast<unsigned long>(string));
        }

        static void gets(char *string, unsigned long size)
        {
            call (EXT_CONSOLE, CONSOLE_READ, size, reinterpret_cast<unsigned long>(string));
        }

        static auto putc(char c)
        {
            return call (EXT_CONSOLE, CONSOLE_WRITE_BYTE, c);
        }
