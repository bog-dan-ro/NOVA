...
/*
 * RISC-V Minimal Guest Memory Space stub
 *
 * Full virtualization support (H-extension) would require nested page tables.
 * For the minimal implementation, this is a stub.
 */
