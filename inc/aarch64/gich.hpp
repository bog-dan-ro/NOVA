...
class Gich final
{
    ...
    private:
        ...
        static void write (Reg32 r, uint32_t v)             { *reinterpret_cast<uint32_t volatile *>(MMAP_GLB_GICH + std::to_underlying (r)) = v; }
        static void write (Arr32 r, unsigned n, uint32_t v) { *reinterpret_cast<uint32_t volatile *>(MMAP_GLB_GICH + std::to_underlying (r) + n * sizeof (uint32_t)) = v; }

        SYSREG32_RW (el2_ap0r0, S3_4_C12_C8_0)
        SYSREG32_RW (el2_ap0r1, S3_4_C12_C8_1)
        SYSREG32_RW (el2_ap0r2, S3_4_C12_C8_2)
        SYSREG32_RW (el2_ap0r3, S3_4_C12_C8_3)
        SYSREG32_RW (el2_ap1r0, S3_4_C12_C9_0)
        SYSREG32_RW (el2_ap1r1, S3_4_C12_C9_1)
        SYSREG32_RW (el2_ap1r2, S3_4_C12_C9_2)
        SYSREG32_RW (el2_ap1r3, S3_4_C12_C9_3)
        SYSREG32_RW (el2_hcr,   S3_4_C12_C11_0)
        SYSREG32_RO (el2_vtr,   S3_4_C12_C11_1)
        SYSREG32_RO (el2_misr,  S3_4_C12_C11_2)
        SYSREG32_RO (el2_eisr,  S3_4_C12_C11_3)
        SYSREG32_RO (el2_elrsr, S3_4_C12_C11_5)
        SYSREG32_RW (el2_vmcr,  S3_4_C12_C11_7)
        SYSREG64_RW (el2_lr0,   S3_4_C12_C12_0)
        SYSREG64_RW (el2_lr1,   S3_4_C12_C12_1)
        SYSREG64_RW (el2_lr2,   S3_4_C12_C12_2)
        SYSREG64_RW (el2_lr3,   S3_4_C12_C12_3)
        SYSREG64_RW (el2_lr4,   S3_4_C12_C12_4)
        SYSREG64_RW (el2_lr5,   S3_4_C12_C12_5)
        SYSREG64_RW (el2_lr6,   S3_4_C12_C12_6)
        SYSREG64_RW (el2_lr7,   S3_4_C12_C12_7)
        SYSREG64_RW (el2_lr8,   S3_4_C12_C13_0)
        SYSREG64_RW (el2_lr9,   S3_4_C12_C13_1)
        SYSREG64_RW (el2_lr10,  S3_4_C12_C13_2)
        SYSREG64_RW (el2_lr11,  S3_4_C12_C13_3)
        SYSREG64_RW (el2_lr12,  S3_4_C12_C13_4)
        SYSREG64_RW (el2_lr13,  S3_4_C12_C13_5)
        SYSREG64_RW (el2_lr14,  S3_4_C12_C13_6)
        SYSREG64_RW (el2_lr15,  S3_4_C12_C13_7)
