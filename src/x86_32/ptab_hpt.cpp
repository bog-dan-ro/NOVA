...
INIT_PRIORITY (PRIO_PTAB) Hptp Hptp::master { Kmem::sym_to_phys (&PTAB_HPAS) };
...
void *Hptp::map_tmp (OAddr phys, size_t size, Paging::Permissions pm, Memattr ma, unsigned)
{
    // Determine remap window boundaries
    uintptr_t v { MMAP_TMP_RW0S };
    uintptr_t e { MMAP_TMP_RW0E };
