...
| :------- | :-----------------: | :-------------------------------- |
| binutils | 2.45                | https://ftp.gnu.org/gnu/binutils/ |
...
```
/opt/aarch64-linux/usr/bin/aarch64-linux-gcc
/opt/aarch64-linux/usr/bin/aarch64-linux-as
/opt/aarch64-linux/usr/bin/aarch64-linux-ld
```

then set `PREFIX_aarch64=/opt/aarch64-linux/usr/bin/aarch64-linux-`
...
The formal specification and proofs for the NOVA microhypervisor are
available on the following branch:
https://gitlab.com/bluerocksec/NOVA/-/tree/proof
